...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *FractalFunction*):
...
Execute unit tests
```
    cd "FractalFunction/test/FractalFunction.Tests"
    dotnet test
```

Deploy application
```
    cd "FractalFunction/src/FractalFunction"
